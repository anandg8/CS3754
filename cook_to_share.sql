...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2017 at 06:27 PM
...
--
-- Table structure for table `cuisine_table`
--

CREATE TABLE `cuisine_table` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `cuisine_table`
--
ALTER TABLE `cuisine_table`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `cuisine_table`
--
ALTER TABLE `cuisine_table`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `user`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key for Users';
--
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comments_ibfk_1` FOREIGN KEY (`vote_id`) REFERENCES `votes` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
...
--
ALTER TABLE `dish`
  ADD CONSTRAINT `dish_ibfk_1` FOREIGN KEY (`comments_id`) REFERENCES `comments` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `dish_ibfk_2` FOREIGN KEY (`cuisine_id`) REFERENCES `cuisine_table` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
...
--
ALTER TABLE `votes`
  ADD CONSTRAINT `votes_ibfk_2` FOREIGN KEY (`comments_id`) REFERENCES `comments` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
